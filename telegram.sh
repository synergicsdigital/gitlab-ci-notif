...
if [ $# -lt 1 ]; then
  echo -e "WARNING!!\nYou need to pass the TELEGRAM_BOT_TOKEN environment variable as the second argument to this script." && exit
fi

if [ $# -lt 2 ]; then
  echo -e "WARNING!!\nYou need to pass the chat_id environment variable as the second argument to this script." && exit
fi
